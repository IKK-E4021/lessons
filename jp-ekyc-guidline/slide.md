...
\[身元確認と当人認証の概念図（再掲）]
![身元確認と当人認証の概念図](https://storage.googleapis.com/generativeai-downloads/images/20250304_meeting_identification-guideline-revision_outline_02.pdf/image_2.jpg)
...
* **スマートフォンへの電子証明書機能搭載（スマホ用電子証明書）:**
    ...
    * **現状:** Android端末向けに2023年5月よりサービス開始。iPhoneは対応時期未定（早期実現目指す）。
