...
1. サービス提供者がチャレンジデータ（ランダムな値）を生成
2. ユーザーがマイナンバーカードを端末にかざし、暗証番号を入力
3. カード内の電子証明書がチャレンジデータに電子署名
4. 署名されたデータと証明書がサービス提供者に送信
5. サービス提供者がJ-LISに証明書の有効性を確認
6. 電子署名と証明書を検証して本人確認完了
